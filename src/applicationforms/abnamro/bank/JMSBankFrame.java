...
public class JMSBankFrame extends JFrame {
    ...
    private DefaultListModel<RequestReply<BankInterestRequest, BankInterestReply>> listModel =
            new DefaultListModel<RequestReply<BankInterestRequest, BankInterestReply>>();
    ...
    private void setupMessageQueue() {
        ...
        new MQueue().listen("bankInterestRequestQueue", new MessageListener() {
